...
void FInv_LabeledNumberFragment::Assimilate(UInv_CompositeBase* Composite) const
{
    ...
    LabeledValue->SetText_Value(FText::AsNumber(Float_Value, &Options), bCollapseValue);
}
...
void FInv_LabeledNumberFragment::Manifest()
{
    ...
    {
        Float_Value = FMath::FRandRange(MinValue, MaxValue);
    }
